(**
   Obtain a dependency DAG from opam files or lockfiles without
...
(** Resolve the dependencies by invoking [opam] on a temporary empty switch.
    ...
    end in [.opam]. Matching lockfiles have the same name with the
    [.locked] prefix.

    @param use_lockfiles whether to consult lockfiles.
    Default: [Use_lockfiles_if_available]
*)
