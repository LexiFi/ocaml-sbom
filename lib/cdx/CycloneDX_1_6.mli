...
val create_externalReference : url:externalReferenceUrl -> ?comment:string -> type_:externalReferenceType -> ?hashes:hash list -> unit -> externalReference
...
module ExternalReference : sig
  ...
  val create : url:externalReferenceUrl -> ?comment:string -> type_:externalReferenceType -> ?hashes:hash list -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
val create_licenseChoiceLicenseChoiceItemsList : license:license -> unit -> licenseChoiceLicenseChoiceItemsList
val licenseChoiceLicenseChoiceItemsList_of_yojson : Yojson.Safe.t -> licenseChoiceLicenseChoiceItemsList
val yojson_of_licenseChoiceLicenseChoiceItemsList : licenseChoiceLicenseChoiceItemsList -> Yojson.Safe.t
val licenseChoiceLicenseChoiceItemsList_of_json : string -> licenseChoiceLicenseChoiceItemsList
val json_of_licenseChoiceLicenseChoiceItemsList : licenseChoiceLicenseChoiceItemsList -> string

module LicenseChoiceLicenseChoiceItemsList : sig
...
val create_cipherSuite : ?name:string -> ?algorithms:refType list -> ?identifiers:string list -> unit -> cipherSuite
...
module CipherSuite : sig
  ...
  val create : ?name:string -> ?algorithms:refType list -> ?identifiers:string list -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
val create_cryptoPropertiesCertificateProperties : ?subjectName:string -> ?issuerName:string -> ?notValidBefore:string -> ?notValidAfter:string -> ?signatureAlgorithmRef:refType -> ?subjectPublicKeyRef:refType -> ?certificateFormat:string -> ?certificateExtension:string -> unit -> cryptoPropertiesCertificateProperties
...
module CryptoPropertiesCertificateProperties : sig
  ...
  val create : ?subjectName:string -> ?issuerName:string -> ?notValidBefore:string -> ?notValidAfter:string -> ?signatureAlgorithmRef:refType -> ?subjectPublicKeyRef:refType -> ?certificateFormat:string -> ?certificateExtension:string -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
val create_cryptoPropertiesProtocolPropertiesIkev2TransformTypes : ?encr:cryptoRefArray -> ?prf:cryptoRefArray -> ?integ:cryptoRefArray -> ?ke:cryptoRefArray -> ?esn:bool -> ?auth:cryptoRefArray -> unit -> cryptoPropertiesProtocolPropertiesIkev2TransformTypes
...
module CryptoPropertiesProtocolPropertiesIkev2TransformTypes : sig
  ...
  val create : ?encr:cryptoRefArray -> ?prf:cryptoRefArray -> ?integ:cryptoRefArray -> ?ke:cryptoRefArray -> ?esn:bool -> ?auth:cryptoRefArray -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
val create_cryptoPropertiesProtocolProperties : ?type_:cryptoPropertiesProtocolPropertiesType -> ?version:string -> ?cipherSuites:cipherSuite list -> ?ikev2TransformTypes:cryptoPropertiesProtocolPropertiesIkev2TransformTypes -> ?cryptoRefArray:cryptoRefArray -> unit -> cryptoPropertiesProtocolProperties
...
module CryptoPropertiesProtocolProperties : sig
  ...
  val create : ?type_:cryptoPropertiesProtocolPropertiesType -> ?version:string -> ?cipherSuites:cipherSuite list -> ?ikev2TransformTypes:cryptoPropertiesProtocolPropertiesIkev2TransformTypes -> ?cryptoRefArray:cryptoRefArray -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
val create_cryptoPropertiesRelatedCryptoMaterialProperties : ?type_:cryptoPropertiesRelatedCryptoMaterialPropertiesType -> ?id:string -> ?state:cryptoPropertiesRelatedCryptoMaterialPropertiesState -> ?algorithmRef:refType -> ?creationDate:string -> ?activationDate:string -> ?updateDate:string -> ?expirationDate:string -> ?value:string -> ?size:int -> ?format:string -> ?securedBy:securedBy -> unit -> cryptoPropertiesRelatedCryptoMaterialProperties
...
module CryptoPropertiesRelatedCryptoMaterialProperties : sig
  ...
  val create : ?type_:cryptoPropertiesRelatedCryptoMaterialPropertiesType -> ?id:string -> ?state:cryptoPropertiesRelatedCryptoMaterialPropertiesState -> ?algorithmRef:refType -> ?creationDate:string -> ?activationDate:string -> ?updateDate:string -> ?expirationDate:string -> ?value:string -> ?size:int -> ?format:string -> ?securedBy:securedBy -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
val create_service : ?bomref:refType -> ?provider:organizationalEntity -> ?group:string -> name:string -> ?version:version -> ?description:string -> ?endpoints:string list -> ?authenticated:bool -> ?xtrustboundary:bool -> ?trustZone:string -> ?data:serviceData list -> ?licenses:licenseChoice -> ?externalReferences:externalReference list -> ?services:service list -> ?releaseNotes:releaseNotes -> ?properties:property list -> ?tags:tags -> ?signature:signature -> unit -> service
...
module Service : sig
  ...
  val create : ?bomref:refType -> ?provider:organizationalEntity -> ?group:string -> name:string -> ?version:version -> ?description:string -> ?endpoints:string list -> ?authenticated:bool -> ?xtrustboundary:bool -> ?trustZone:string -> ?data:serviceData list -> ?licenses:licenseChoice -> ?externalReferences:externalReference list -> ?services:service list -> ?releaseNotes:releaseNotes -> ?properties:property list -> ?tags:tags -> ?signature:signature -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
val create_metadata : ?timestamp:string -> ?lifecycles:metadataLifecycles list -> ?tools:metadataTools -> ?manufacturer:organizationalEntity -> ?authors:organizationalContact list -> ?component:component -> ?manufacture:organizationalEntity -> ?supplier:organizationalEntity -> ?licenses:licenseChoice -> ?properties:property list -> unit -> metadata
...
module Metadata : sig
  ...
  val create : ?timestamp:string -> ?lifecycles:metadataLifecycles list -> ?tools:metadataTools -> ?manufacturer:organizationalEntity -> ?authors:organizationalContact list -> ?component:component -> ?manufacture:organizationalEntity -> ?supplier:organizationalEntity -> ?licenses:licenseChoice -> ?properties:property list -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
val create_licenseChoiceItems : license:license -> unit -> licenseChoiceItems
...
val create_cycloneDXBillofMaterialsStandardDefinitions : ?standards:standard list -> unit -> cycloneDXBillofMaterialsStandardDefinitions
...
module CycloneDXBillofMaterialsStandardDefinitions : sig
  ...
  val create : ?standards:standard list -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
...
module CycloneDXBillofMaterialsStandard : sig
  ...
  val create : ?schema:string -> bomFormat:cycloneDXBillofMaterialsStandardBomFormat -> specVersion:string -> ?serialNumber:string -> ?version:int -> ?metadata:metadata -> ?components:component list -> ?services:service list -> ?externalReferences:externalReference list -> ?dependencies:dependency list -> ?compositions:compositions list -> ?vulnerabilities:vulnerability list -> ?annotations:annotations list -> ?formulation:formula list -> ?declarations:cycloneDXBillofMaterialsStandardDeclarations -> ?definitions:cycloneDXBillofMaterialsStandardDefinitions -> ?properties:property list -> ?signature:signature -> unit -> t
  val of_yojson : Yojson.Safe.t -> t
  val to_yojson : t -> Yojson.Safe.t
  val of_json : string -> t
  val to_json : t -> string
